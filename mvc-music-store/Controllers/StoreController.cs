...
namespace mvc_music_store.Controllers
{
    public class StoreController : Controller
    {
        ...
        {
            // if there is no CartId session variable (this is their first item)
        ...
        {
            // migrate the cart to the username if anon
            MigrateCart();
            return View();
        }
        ...
        public ActionResult Checkout(FormCollection values)
        {
            ...
            // auto populate the fields that we can
        ...
        {
            // attach anonymous cart to an authenticated user once they log in
